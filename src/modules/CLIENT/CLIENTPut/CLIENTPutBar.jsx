...
const CLIENTPutBar = () => {
  ...
  const [clientURL, setClientURL] = useState(
    `${serviceURL}/client/put/${lastRecord}`
  );
  ...
  return (
    <>
      ...
      <DailyChartOI
        ...
        data={clientData}
        title="CLIENT PUT DATA OI CHANGE 2020"
      />
      ...
      <PieChart
        ...
        clientCode="CLIENT PUT POSITION"
