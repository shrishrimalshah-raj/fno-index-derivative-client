...
const PROFutureBar = () => {
  ...
  const [proURL, setProURL] = useState(
    `${serviceURL}/pro/future/${lastRecord}`
  );
  ...
  return (
    <>
      ...
      <DailyChartOI
        ...
        data={proData}
        title="PRO FUTURE DATA OI CHANGE 2020"
      />
      ...
      <PieChart
        ...
        clientCode="PRO FUTURE POSITION"
